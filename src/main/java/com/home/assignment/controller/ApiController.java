...
public class ApiController {
    ...
    private static String[] columns = { "Employee ID", "Number of Hours", "Unit Price",
            "Cost" };
    @GetMapping("/")
    public String index() {
        return "upload";
    ...
    private Map getCompanyInvoices(File csv) throws IOException, ParseException, IllegalArgumentException, InvalidInputException {
        ...
        System.out.println(companyInvoices.size());
